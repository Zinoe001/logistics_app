...
class BadRequestException extends DioException with Failure {
  ...
  @override
  String get message =>
      _getServerError(serverResponse?.data) ?? "Invalid request";
...
class ConflictException extends DioException with Failure {
  ...
  @override
  String get message =>
      _getServerError(serverResponse?.data) ?? "Conflict occurredd.";
...
class NotFoundException extends DioException with Failure {
  ...
  @override
  String get message =>
      _getServerError(serverResponse?.data) ?? "Not Found, please try again.";
...
class ServerCommunicationException extends DioException with Failure {
  ...
  String get message {
    try {
      return _getServerError(r?.data) ?? "Server Error";
    } catch (e) {
...
String? _getServerError(Map<String, dynamic>? response) {
  try {
    if (response == null) return null;
    bool hasErrorParams = response["errors"] != null;
    if (hasErrorParams) {
      try {
        String? error = ((response["errors"] as Map).values.first as List)[0];
